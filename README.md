...
![Demo GIF](docs/assets/SmartSupport.gif)  
*Демонстрация работы платформы: от ввода запроса до обработки и отправки ответа. GIF показывает полный цикл с несколькими примерами (например, запрос о регистрации в банке).* 📹

## 📋 Оглавление
- [Описание](#описание)
- [Технический стек](#технический-стек)
- [Функциональность](#функциональность)
- [Сценарий использования Веб-Сервиса](#сценарий-использования-веб-сервиса)
- [Применимость Smart Support](#применимость-smart-support)
...
4. **Фильтрация шаблонов по категории и эмбеддингам**
    - Выбор наиболее подходящего шаблона.
    - Уровень пригодности берется из сходства embedding.

5. **Отправка на Frontend**
...
## Применимость Smart Support 🌐

**В бизнес-сегменте:**  
**Целевая аудитория:** Оператор, аналитик, клиент 👥
